...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "DailyNewsTap — Premium Nigerian News & Editorial Journalism" },
      { property: "og:description", content: "DailyNewsTap delivers authoritative, premium journalism on Nigerian politics, business, technology, sports and world affairs." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@DailyNewsTap" },
      { name: "twitter:title", content: "DailyNewsTap — Premium Nigerian News & Editorial Journalism" },
      { name: "twitter:description", content: "DailyNewsTap delivers authoritative, premium journalism on Nigerian politics, business, technology, sports and world affairs." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/2474896c-c59a-471c-a805-ec0139a63154/id-preview-107fd8b7--59790c57-8994-477a-a831-c21539c50b0c.lovable.app-1779197113677.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/2474896c-c59a-471c-a805-ec0139a63154/id-preview-107fd8b7--59790c57-8994-477a-a831-c21539c50b0c.lovable.app-1779197113677.png" },
    ],
    links: [
